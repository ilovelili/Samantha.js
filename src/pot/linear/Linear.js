...
goog.provide('Samantha.pot.Linear');
goog.require('Samantha.pot.LinearModel');
 ...
 */
Samantha.pot.Linear = function(param, name, multiplier, opt_size, opt_min, opt_max, opt_default) {
    goog.base(this, param, name, multiplier, opt_size, opt_min, opt_max, opt_default);
};
goog.inherits(Samantha.pot.Linear, Samantha.pot.Pot);


/**
 * @type {function(new: Samantha.pot.LinearModel, (AudioParam|Function), string, number, number=, number=, number=)}
 *       The component model this pot component will work with.
 * @override
 */
Samantha.pot.Linear.prototype.modelClass = Samantha.pot.LinearModel;

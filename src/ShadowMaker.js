/**
 * @fileoverview ShadowMaker for Samantha.
 */


goog.provide('Samantha.shadowMaker');
 ...
 */
Samantha.shadowMaker = function(element, length, darkness, weight, opt_before, opt_after) {
 ...
 */
Samantha.textShadowMaker = function(element, length, before, after, invertY, invertX) {
    before = before || [];
    after = after || [];
    var elStyle = document.defaultView.getComputedStyle(element, null);
...
Samantha.textShadowMakerDom = function(element, length) {

 ...
 * Example usage:
 *
 * goog.events.listen(document.body, SamanthaClosure.events.EventType.TAP, function() {
 *     console.log('tapped!');
 * });
 *
 */

goog.provide('SamanthaClosure.events.GestureHandler');
 ...
 */
SamanthaClosure.events.GestureHandler = function(opt_el) {
...
goog.addSingletonGetter(SamanthaClosure.events.GestureHandler);
 ...
 * @type {?boolean}
 */
SamanthaClosure.events.GestureHandler.prototype.deviceIsIOSWithBadTarget = navigator.userAgent.match(/iPhone/i) &&
    (/OS ([6-9]|\d{2})_\d/).test(navigator.userAgent);


SamanthaClosure.events.GestureHandler.prototype.onTouchstart = function(e) {
...
SamanthaClosure.events.GestureHandler.prototype.onTouchmove = function(e) {
    ...
    if (this.canSwipe) {
        ...
        if ((touches.length / 3) > 1) {
            ...
            var eventType = SamanthaClosure.events.EventType.SWIPE_RIGHT;
            if (angle > 45 && angle < 135) {
                eventType = SamanthaClosure.events.EventType.SWIPE_DOWN;
            }
            else if (angle > 135 && angle < 225) {
                eventType = SamanthaClosure.events.EventType.SWIPE_LEFT;
            }
            else if (angle > 225 && angle < 315) {
                eventType = SamanthaClosure.events.EventType.SWIPE_UP;
            }
...
SamanthaClosure.events.GestureHandler.prototype.onTouchend = function(e) {
    ...
    if (this.canTap) {
        ...
        tap.initEvent(SamanthaClosure.events.EventType.TAP, true, true);

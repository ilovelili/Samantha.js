...
goog.provide('SamanthaClosure.ui.TooltipComponent');
goog.require('goog.dom');
goog.require('goog.dom.query');
goog.require('goog.style');
goog.require('SamanthaClosure.ui.Component');
goog.require('SamanthaClosure.ui.TooltipComponentModel');



/**
 * @constructor
 * @extends {SamanthaClosure.ui.Component}
 */
SamanthaClosure.ui.TooltipComponent = function(refElement, options) {
...
goog.inherits(SamanthaClosure.ui.TooltipComponent, SamanthaClosure.ui.Component);

SamanthaClosure.ui.TooltipComponent.prototype.modelClass = SamanthaClosure.ui.TooltipComponentModel;

SamanthaClosure.ui.TooltipComponent.prototype.id = 'SamanthaTooltip';
SamanthaClosure.ui.TooltipComponent.prototype.cssClass = 'SamanthaTooltip';


/** @param {Element} refElement Reference element. */
SamanthaClosure.ui.TooltipComponent.prototype.setRefElement = function(refElement) {
...
/** @override */
SamanthaClosure.ui.TooltipComponent.prototype.bindDomEvents = function() {
...
SamanthaClosure.ui.TooltipComponent.prototype.onClick = function(e) {
    ...
    this.bodyListen = goog.events.listen(document.body, goog.events.EventType.CLICK, function(e) {
        ...
        this.model.handleEvent(SamanthaClosure.ui.TooltipComponentModel.SMEventType.BODY_CLICK);
    }, false, this);
};

SamanthaClosure.ui.TooltipComponent.prototype.onHover = function(e) {
...
SamanthaClosure.ui.TooltipComponent.prototype.onBoxMouseout = function(e) {
...
SamanthaClosure.ui.TooltipComponent.prototype.unbindDomEvents = function() {
...
/** @override */
SamanthaClosure.ui.TooltipComponent.prototype.bindModelEvents = function() {
    goog.events.listen(this.model, SamanthaClosure.ui.TooltipComponentModel.EventType.SHOW, this.onShow, undefined, this);
    goog.events.listen(this.model, SamanthaClosure.ui.TooltipComponentModel.EventType.INIT, this.onInit, undefined, this);
    goog.events.listen(this.model, SamanthaClosure.ui.TooltipComponentModel.EventType.CLICK_WAIT, this.onWait, undefined,
        this);
};


SamanthaClosure.ui.TooltipComponent.prototype.onWait = function() {
...
SamanthaClosure.ui.TooltipComponent.prototype.onShow = function() {
...
SamanthaClosure.ui.TooltipComponent.prototype.reset = function() {
    this.model.reset(); // sends to onInit
};

SamanthaClosure.ui.TooltipComponent.prototype.onInit = function() {
    this.element.style.display = 'none';
 ...
 * @return {string}
 */
SamanthaClosure.ui.TooltipComponent.prototype.templates_base = function() {
 ...
 * @return {string}
 */
SamanthaClosure.ui.TooltipComponent.prototype.templates_loading = function() {
 ...
 */
SamanthaClosure.ui.TooltipComponent.prototype.setContent = function(content) {
 ...
 *
 **/
SamanthaClosure.ui.TooltipComponent.prototype.position = function() {
    ...
    if ((refElementOffset.x < winScrollLeft) &&
        ...
        topDown = false;
        this.model.options.direction = SamanthaClosure.ui.TooltipComponentModel.Direction.RIGHT;
        horizontalTipCapShift = -8;
    }

    if (myWindowSize.width + winScrollLeft - refElementOffset.x < 2 * this.model.tipOffset) {
        topDown = false;
        this.model.options.direction = SamanthaClosure.ui.TooltipComponentModel.Direction.LEFT;
    ...
    if (topDown) {
        ...
        if (horizontalShift == 0) {
            if (myWrapperSize.width + (refElementOffset.x - winScrollLeft) > myWindowSize.width &&
                this.model.options.direction != SamanthaClosure.ui.TooltipComponentModel.Direction.TOP_LEFT) {
        ...
        if (refElementOffset.y - winScrollTop >= myElementSize.height + this.model.tipOffset + this.model.boxOffset) {
            if (this.model.options.direction != SamanthaClosure.ui.TooltipComponentModel.Direction.TOP_LEFT) {
                this.model.options.direction = SamanthaClosure.ui.TooltipComponentModel.Direction.TOP;
            }
            verticalTipCapShift = myWrapperSize.height;
        }
        else {
            this.model.options.direction = SamanthaClosure.ui.TooltipComponentModel.Direction.BOTTOM;
    ...
    switch (this.model.options.direction) {
        case SamanthaClosure.ui.TooltipComponentModel.Direction.LEFT:
            handlerFn = this.positionLeft;
            break;
        case SamanthaClosure.ui.TooltipComponentModel.Direction.RIGHT:
            handlerFn = this.positionRight;
            break;
        case SamanthaClosure.ui.TooltipComponentModel.Direction.BOTTOM:
            handlerFn = this.positionBottom;
            break;
        case SamanthaClosure.ui.TooltipComponentModel.Direction.TOP:
            handlerFn = this.positionTop;
            break;
        case SamanthaClosure.ui.TooltipComponentModel.Direction.TOP_LEFT:
 ...
 */
SamanthaClosure.ui.TooltipComponent.prototype.positionLeft = function(refElementOffset, refElementSize, myElementSize) {
 ...
 * @return {goog.math.Coordinate}
 */
SamanthaClosure.ui.TooltipComponent.prototype.positionTop = function(refElementOffset, refElementSize, myElementSize) {
 ...
 * @return {goog.math.Coordinate}
 */
SamanthaClosure.ui.TooltipComponent.prototype.positionTopLeft = function(refElementOffset, refElementSize, myElementSize) {
    var y = refElementOffset.y - (myElementSize.height);
 ...
 * @return {goog.math.Coordinate}
 */
SamanthaClosure.ui.TooltipComponent.prototype.positionBottom = function(refElementOffset, refElementSize, myElementSize) {
 ...
 * @return {goog.math.Coordinate}
 */
SamanthaClosure.ui.TooltipComponent.prototype.positionRight = function(refElementOffset, refElementSize, myElementSize) {
    var y = refElementOffset.y - 16;

/**
 * @fileoverview SamanthaClosure.Pagination is an event driven Pagination object.
 *
 * Example usage:
 *
 *  var paginator = new SamanthaClosure.Pagination();
 *
 *  paginator.setTotalPage(5);
 *  paginator.setCurrentPage(2);
 *
 *  goog.events.listen(paginator, SamanthaClosure.Pagination.EventTypes.PAGE_CHANGED, function (e) {
...
goog.provide('SamanthaClosure.Pagination');
 ...
 */
SamanthaClosure.Pagination = function() {
...
goog.inherits(SamanthaClosure.Pagination, goog.events.EventTarget);
 ...
 * @enum {string}
 */
SamanthaClosure.Pagination.EventTypes = {
 ...
 * @protected
 */
SamanthaClosure.Pagination.prototype.triggerPageChange_ = function(oldValue, newValue) {
    if (oldValue != newValue)
        this.dispatchEvent({type: SamanthaClosure.Pagination.EventTypes.PAGE_CHANGED, oldValue: oldValue, newValue: newValue});
};
 ...
 */
SamanthaClosure.Pagination.prototype.getTotalPage = function() {
 ...
 * @return {SamanthaClosure.Pagination} .
 */
SamanthaClosure.Pagination.prototype.setTotalPage = function(page) {
 ...
 */
SamanthaClosure.Pagination.prototype.getCurrentPage = function() {
 ...
 * @return {SamanthaClosure.Pagination} .
 */
SamanthaClosure.Pagination.prototype.setCurrentPage = function(page) {
 ...
 */
SamanthaClosure.Pagination.prototype.getTotalItems = function() {
 ...
 * @return {SamanthaClosure.Pagination} .
 */
SamanthaClosure.Pagination.prototype.setTotalItems = function(itemCount) {
 ...
 */
SamanthaClosure.Pagination.prototype.getItemPerPage = function() {
 ...
 * @return {SamanthaClosure.Pagination} .
 */
SamanthaClosure.Pagination.prototype.setItemPerPage = function(itemPerPage) {
 ...
 */
SamanthaClosure.Pagination.prototype.hasNext = function() {
 ...
 */
SamanthaClosure.Pagination.prototype.getNext = function() {
 ...
 */
SamanthaClosure.Pagination.prototype.hasPrev = function() {
 ...
 */
SamanthaClosure.Pagination.prototype.getPrev = function() {
 ...
 */
SamanthaClosure.Pagination.prototype.next = function() {
    var oldValue = this.currentPage;
 ...
 */
SamanthaClosure.Pagination.prototype.prev = function() {
    var oldValue = this.currentPage;

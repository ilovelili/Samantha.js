/**
 * @fileoverview SamanthaClosure.Carousel is an event driven Carousel/Image Slider class
 ...
 *  ]; //seven items
 *
 *  var carousel = new SamanthaClosure.Carousel(items);
 *
 *  carousel.setItemPerViewport(2); //only 2 items is visibile
 *
 *  goog.events.listen(carousel, SamanthaClosure.Carousel.EventTypes.NEXT, function (e) {
 ...
 *  });
 *
 *  goog.events.listen(carousel, SamanthaClosure.Carousel.EventTypes.PREV, function (e) {
 ...
 *  //items : 'six', 'seven'
 *  carousel.next(1);
 *  //items : 'six', 'seven' which is end of items, for circular navigation use SamanthaClosure.CircularCarousel instead
 *  carousel.prev(1);
 *  //items : 'five', 'six'
 *  carousel.prev(99999);
 *  //items : 'one', 'two'
...
goog.provide('SamanthaClosure.Carousel');
goog.provide('SamanthaClosure.Carousel.EventTypes');
 ...
 * @constructor
 */
SamanthaClosure.Carousel = function(items) {
...
goog.inherits(SamanthaClosure.Carousel, goog.events.EventTarget);
 ...
 * @enum {string}
 */
SamanthaClosure.Carousel.EventTypes = {
    MOVED: 'moved',
    PREV: 'prev',
    NEXT: 'next'
};
 ...
 * @return {SamanthaClosure.Carousel} itself for chaining.
 */
SamanthaClosure.Carousel.prototype.setItemPerViewport = function(itemPerViewport) {
 ...
 */
SamanthaClosure.Carousel.prototype.getItemPerViewport = function() {
 ...
 */
SamanthaClosure.Carousel.prototype.getVisibleItems = function() {
 ...
 */
SamanthaClosure.Carousel.prototype.getVisibleItemIndexes = function() {
    var indexes = {
 ...
 * @private
 */
SamanthaClosure.Carousel.prototype.getMaxMoveCount_ = function(direction, moveCount) {
    var maxMoveCount;
 ...
 */
SamanthaClosure.Carousel.prototype.getItemsToBeInsertedAndRemoved = function(moveCount) {
    var i,
        previousItemsIndex = [],
        nextItemsIndex = [];
 ...
 * @protected
 */
SamanthaClosure.Carousel.prototype.getMoveDiff = function(a1, a2, moveCount) {
 ...
 * @protected
 */
SamanthaClosure.Carousel.prototype.move = function(direction, moveCount) {
    ...
    var eventToDispatch = SamanthaClosure.Carousel.EventTypes.NEXT;

    if (direction == 'prev') {
        moveCount = moveCount * -1;
        eventToDispatch = SamanthaClosure.Carousel.EventTypes.PREV;
    }
 ...
 */
SamanthaClosure.Carousel.prototype.next = function(moveCount) {
 ...
 * @param {number|*} moveCount cursor move count.
 */
SamanthaClosure.Carousel.prototype.prev = function(moveCount) {
